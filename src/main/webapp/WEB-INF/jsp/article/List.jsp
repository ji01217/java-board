...
<div class="container" style="max-width: 800px;">
    <h1 class="mb-3 fw-bold">게시글 목록</h1>
    <hr/>
    ...
    <c:if test="${pageCnt > 0}">
        <nav aria-label="Page navigation">
            <ul class="pagination justify-content-center">
                <li class="page-item">
                    <a class="page-link" href="/article/list?page=${nowPage-1}" id="previousBtn">
                        <span>&laquo;</span>
                    </a>
                </li>
                <c:forEach var="page" begin="1" end="${pageCnt}">
                    <li class="page-item"><a class="page-link " href="/article/list?page=${page}"
                                             id="${page}Btn">${page}</a></li>
                </c:forEach>
                <li class="page-item">
                    <a class="page-link" href="/article/list?page=${nowPage+1}" id="nextBtn">
                        <span>&raquo;</span>
                    </a>
                </li>
            </ul>
